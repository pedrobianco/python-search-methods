...
class Search(SearchAbstract):
    ...
    # Metodo responsavel por selecionar todos os pixels pretos ja selecionados
    def set_position_black_pixels(self, row, col, up, right, bottom, left):
        # Dicionario contendo posicao row,col do pixel preto
    ...
    # Metodo responsavel por verificar se ha caminho disponivel para acessar
    ...
    def save_image(self):
        ...
        img.show()
        img.save('/response/cost_uniform/solutions.jpeg', 'JPEG')